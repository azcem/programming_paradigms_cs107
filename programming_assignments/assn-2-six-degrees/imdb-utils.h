...
inline const char *determinePathToData(const char *userSelectedPath = NULL)
{
  ...
  //we know we work on linux so hardcoded for now 
  return "/home/assem/coding/programming_paradigms_cs107/programming_assignments/assn-2-six-degrees-data/little-endian/";
